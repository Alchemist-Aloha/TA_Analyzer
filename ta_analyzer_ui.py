    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(
            QCoreApplication.translate(
                "MainWindow", "Transient Absorption Analyzer", None
            )
        )
        self.label.setText(QCoreApplication.translate("MainWindow", "TextLabel", None))
        self.button_load.setText(QCoreApplication.translate("MainWindow", "load", None))
        self.button_bgcorr.setText(
            QCoreApplication.translate("MainWindow", "bgcorr", None)
        )
        self.button_tcorr.setText(
            QCoreApplication.translate("MainWindow", "tcorr", None)
        )
        self.button_glotaran.setText(
            QCoreApplication.translate("MainWindow", "glotaran", None)
        )
        self.button_spectra.setText(
            QCoreApplication.translate("MainWindow", "PushButton", None)
        )
        self.button_traces.setText(
            QCoreApplication.translate("MainWindow", "PushButton", None)
        )
        self.button_fit.setText(
            QCoreApplication.translate("MainWindow", "PushButton", None)
        )
